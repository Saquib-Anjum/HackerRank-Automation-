...
long totalSum = 0, minVal = arr[0], maxVal = arr[0];
    for (int num : arr) {
        totalSum += num;
...
int maxVal = *max_element(candles.begin(), candles.end());
    return count(candles.begin(), candles.end(), maxVal);
}
...
int hh = stoi(s.substr(0, 2));
    ...
    stringstream ss;
    ss << setw(2) << setfill('0') << hh << s.substr(2, 6);
    return ss.str();
}
